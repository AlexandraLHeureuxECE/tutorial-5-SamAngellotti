...
function clickCircle() {
	diagnostic = this.style.backgroundColor;
	console.log(diagnostic);
	if (diagnostic == pickedColor){
...
function genRandomColours() {
	...
	for (let i = 0; i < numCircles; i++){
		coloursAnswer[i] = makeColour();
	}
	return coloursAnswer;
}
...
function chooseColor() {
	return colours[Math.floor(Math.random()*numCircles)]//returns number of index 0 - 5
}
